...
describe('Rating', () => {
  it('should display the 5 stars rating when the passed value is bigger than 4.5', () => {
  ...
  it('should display the 4 stars rating when the passed value is bigger than 3.5 and lower than 4.5', () => {
  ...
  it('should display the 3 stars rating when the passed value is bigger than 2.5 and lower than 3.5', () => {
  ...
  it('should display the 2 stars rating when the passed value is bigger than 1.5 and lower than 2.5', () => {
  ...
  it('should display the 1 star rating when the passed value is bigger than 0.5 and lower than 1.5', () => {
  ...
  it('should display the 0 star rating when the passed value is lower than 0.5', () => {
